...
if car > 1000000:
    ...
    print('You are eligible to purchase a AMG BENZ C200')
elif 750000 <= car < 850000:
    print('You are eligible to purchase a ford')
elif 650000 <= car < 750000:
    print('You are eligible to purchase a Ram')
elif 550000 <= car < 650000:
    print('You are eligible to purchase a dodge chager')
elif 450000 <= car < 550000:
    print('You are eligible to purchase a honda')
elif 350000 <= car < 450000:
    print('You are eligible to purchase a corolla s')
elif 250000 <= car < 350000:
    print('You are eligible to purchase an vitz')
elif 150000 <= car < 250000:
    print('You are eligible to purchase a litux')
elif 100000 <= car < 150000:
    print('You are eligible to purchase a matiz')
elif 95000 <= car < 100000:
    print('You are eligible to purchase a kia')
elif 90000 <= car < 95000:
    print('You are eligible to purchase a tasla')
    ...
    print('You are eligible to purchase a Kia 250')
